...
_Generated: 2026-04-02T09:04:17.141Z_
...
Workspace `mcp.json` _(folder: motamayez-server)_

- **e:\motamayez-server\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\deyaa\AppData\Roaming\Code\User\mcp.json** — _File missing_
